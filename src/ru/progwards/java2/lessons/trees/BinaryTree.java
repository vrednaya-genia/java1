...
public class BinaryTree<K extends Comparable<K>, V> implements Iterable<BinaryTree.TreeLeaf> {
    private static final String KEYNOTEXIST = "Key doesn't exist";
    private static final String KEYEXIST = "Key already exists";
    ...
    class TreeLeaf<K extends Comparable<K>, V> {
        ...
        public void delete() throws TreeException {
    ...
    @Override
    public Iterator<BinaryTree.TreeLeaf> iterator() {
        return getIterator();
    }
}
